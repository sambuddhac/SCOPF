...
void GensolverFirst::load_default_data(int APPItCount, double gsRho, double Pgenprev, double Pgenavg, double Powerprice, double Angpriceavg, double Angavg, double Angprice, double PgenAPP, double BAPP, double LambAPP1) {
 if (APPItCount==1) {
  params.rho[0] = gsRho;
  params.PgAPPSC[0] = 0.0;
  params.BSC[0] = 0.0;
