...
#ifndef GENSOLVERBASE_H
#define GENSOLVERBASE_H
#include <array>
#include <ctime>
#include <cstdlib>
...
double *Thiterate;
public:
GensolverBase(int, double, double, double, double, double, double, double); // Gensolver object constructor
~GensolverBase(); // Gensolver object destructor
double getPMax(); // Gets the maximum power generating limit
double getPMin(); // Gets the minimum power generating limit
double getQuadCost(); // Gets the Quadratic cost coefficient
double getLinCost(); // Gets the Linear cost coefficient
double getNLCost(); // Gets the Constant coefficient
