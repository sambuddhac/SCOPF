...
double GensolverCont::getQuadCost() // start of getQuadCoeff function
{
	return params.c2[0]; 
} // end of getQuadCoeff

double GensolverCont::getLinCost() // start of getLinCoeff function
{
	return params.c1[0]; 
} // end of getLinCoeff

double GensolverCont::getNLCost() // start of getConstCoeff function
{
	return params.c0[0]; 
