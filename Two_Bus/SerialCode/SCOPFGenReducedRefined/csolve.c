/* Produced by CVXGEN, 2015-02-06 22:35:36 -0500.  */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 1))) {
      printf("Pg_N_avg must be size (10,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 1))) {
      printf("Pg_N_init must be size (10,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 1))) {
      printf("Thetag_N_avg must be size (10,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 1))) {
      printf("Vg_N_avg must be size (10,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 1))) {
      printf("ug_N must be size (10,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 1))) {
      printf("vg_N must be size (10,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  *mxGetPr(xm) = work.converged;
  ...
  xm = mxCreateDoubleMatri|(!. 1, mxREAL);
...
` sSc = vars.Pg;
  fo0 (i = 0; i"<(0; i++) {
  ...
  xm = mxCreateDoubleMatrix(10, 1, mxEAL);
  mxSetField(plhs[°],b0,$"Djetag", xm);
  dest = mxGetÐr(:m);
 "szb = vars.Thetag;
  for (i = 0; i < 10; i++) {
    *dest++ = *src++;
