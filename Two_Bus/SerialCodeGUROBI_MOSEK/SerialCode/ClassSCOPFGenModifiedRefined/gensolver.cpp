...
double Gensolver::eval_objv(void) {
  ...
  objv += params.c0[0]+work.quad_649250897920[0]+work.quad_582958280704[0];
  return objv;
}
...
//ldl.cpp
/* Produced by CVXGEN, 2015-03-30 03:43:31 -0400.  */
/* CVXGEN is Copyright (C) 2006-2012 Jacob Mattingley, jem@cvxgen.com. */
/* The code in this file is Copyright (C) 2006-2012 Jacob Mattingley. */
/* CVXGEN, or solvers produced by CVXGEN, cannot be used for commercial */
/* applications without prior written permission from Jacob Mattingley. */
...
void Gensolver::fill_KKT(void) {
  work.KKT[107] = 2*(params.c2[0]+work.quad_288445386752[0]+work.frac_121674190848*params.contNum[0]);
...
array<double, 101> Gensolver::getThetaSol(void) {
for ( int i = 0; i <= 100; ++i ) {
