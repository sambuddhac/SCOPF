...
typedef struct Workspace_t {
  ...
  double quad_816698011648[1];
  double quad_36347121664[1];
  double quad_738596147200[1];
  int converged;
} Workspace;
...
//*array<double, 2> getThetaSol(void);
double getObj(void);
