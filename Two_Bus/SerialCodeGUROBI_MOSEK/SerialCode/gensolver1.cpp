...
/*array<double, 2> Gensolver::getThetaSol(void) {
for ( int i = 0; i <= 1; ++i ) {
...
double Gensolver::eval_objv(void) {
  ...
  objv += params.c0[0]+work.frac_121674190848*(work.quad_36347121664[0]+work.quad_738596147200[0]);
  return objv;
}
...
void Gensolver::ldl_solve(double *target, double *var) {
  ...
  work.v[2] = target[3];
  work.v[3] = target[4];
  work.v[4] = target[5]-work.L[0]*work.v[2];
  work.v[5] = target[0]-work.L[1]*work.v[4];
  work.v[6] = target[6]-work.L[2]*work.v[3]-work.L[3]*work.v[5];
  /* Diagonal scaling. Assume correctness of work.d_inv. */
  for (i = 0; i < 7; i++)
    work.v[i] *= work.d_inv[i];
  /* Back substitution */
  work.v[5] -= work.L[3]*work.v[6];
  work.v[4] -= work.L[1]*work.v[5];
  work.v[3] -= work.L[2]*work.v[6];
...
void Gensolver::ldl_factor(void) {
  ...
  work.L[2] = (work.KKT[5])*work.d_inv[3];
  work.v[2] = work.L[0]*work.d[2];
  work.v[4] = work.KKT[6]-work.L[0]*work.v[2];
  work.d[4] = work.v[4];
  if (work.d[4] > 0)
  ...
  work.v[5] = work.KKT[8]-work.L[1]*work.v[4];
  work.d[5] = work.v[5];
  if (work.d[5] < 0)
  ...
  work.L[3] = (work.KKT[9])*work.d_inv[5];
  work.v[3] = work.L[2]*work.d[3];
  work.v[5] = work.L[3]*work.d[5];
  work.v[6] = work.KKT[10]-work.L[2]*work.v[3]-work.L[3]*work.v[5];
  work.d[6] = work.v[6];
  if (work.d[6] > 0)
...
double Gensolver::check_factorization(void) {
  ...
  residual = 0;
  temp = work.KKT[8]-1*work.d[5]*1-work.L[1]*work.d[4]*work.L[1];
  residual += temp*temp;
  ...
  residual += temp*temp;
  temp = work.KKT[5]-work.L[2]*work.d[3]*1;
  residual += temp*temp;
  temp = work.KKT[6]-work.L[0]*work.d[2]*work.L[0]-1*work.d[4]*1;
  residual += temp*temp;
  temp = work.KKT[10]-work.L[2]*work.d[3]*work.L[2]-1*work.d[6]*1-work.L[3]*work.d[5]*work.L[3];
  residual += temp*temp;
  temp = work.KKT[7]-1*work.d[4]*work.L[1];
  residual += temp*temp;
  temp = work.KKT[9]-work.L[3]*work.d[5]*1;
  residual += temp*temp;
  return residual;
}
void Gensolver::matrix_multiply(double *result, double *source) {
  /* Finds result = A*source. */
  result[0] = work.KKT[8]*source[0]+work.KKT[7]*source[5]+work.KKT[9]*source[6];
  result[1] = work.KKT[0]*source[1];
  result[2] = work.KKT[1]*source[2];
  result[3] = work.KKT[2]*source[3]+work.KKT[3]*source[5];
  result[4] = work.KKT[4]*source[4]+work.KKT[5]*source[6];
  result[5] = work.KKT[3]*source[3]+work.KKT[6]*source[5]+work.KKT[7]*source[0];
  result[6] = work.KKT[5]*source[4]+work.KKT[10]*source[6]+work.KKT[9]*source[0];
}
...
void Gensolver::fill_KKT(void) {
  work.KKT[8] = 2*(params.c2[0]+work.frac_121674190848*work.quad_816698011648[0]);
