/* Produced by CVXGEN, 2015-09-15 18:15:30 -0400.  */
...
/*array<double, 3> Gensolver::getThetaSol(void) {
for ( int i = 0; i <= 2; ++i ) {
...
double Gensolver::eval_objv(void) {
  ...
  objv += params.c0[0]+work.frac_121674190848*(work.quad_46264983552[0]+work.quad_955552309248[0]);
  return objv;
}
...
void Gensolver::multbyP(double *lhs, double *rhs) {
  ...
  lhs[0] = rhs[0]*(2*(params.c2[0]+work.frac_121674190848*work.quad_961296547840[0]));
...
void Gensolver::fillq(void) {
  work.q[0] = params.c1[0]+2*work.frac_121674190848*((-params.Pg_N_init[0]+params.Pg_N_avg[0]+params.ug_N[0])*params.ones[0]+(-params.Pg_N_init[1]+params.Pg_N_avg[1]+params.ug_N[1])*params.ones[1]+(-params.Pg_N_init[2]+params.Pg_N_avg[2]+params.ug_N[2])*params.ones[2]);
...
void Gensolver::pre_ops(void) {
  ...
  work.quad_961296547840[0] = params.ones[0]*params.ones[0]+params.ones[1]*params.ones[1]+params.ones[2]*params.ones[2];
  work.quad_46264983552[0] = ((-params.Pg_N_init[0]+params.Pg_N_avg[0]+params.ug_N[0])*(-params.Pg_N_init[0]+params.Pg_N_avg[0]+params.ug_N[0])+(-params.Pg_N_init[1]+params.Pg_N_avg[1]+params.ug_N[1])*(-params.Pg_N_init[1]+params.Pg_N_avg[1]+params.ug_N[1])+(-params.Pg_N_init[2]+params.Pg_N_avg[2]+params.ug_N[2])*(-params.Pg_N_init[2]+params.Pg_N_avg[2]+params.ug_N[2]));
  work.quad_955552309248[0] = ((-params.Vg_N_avg[0]-params.Thetag_N_avg[0]+params.vg_N[0])*(-params.Vg_N_avg[0]-params.Thetag_N_avg[0]+params.vg_N[0])+(-params.Vg_N_avg[1]-params.Thetag_N_avg[1]+params.vg_N[1])*(-params.Vg_N_avg[1]-params.Thetag_N_avg[1]+params.vg_N[1])+(-params.Vg_N_avg[2]-params.Thetag_N_avg[2]+params.vg_N[2])*(-params.Vg_N_avg[2]-params.Thetag_N_avg[2]+params.vg_N[2]));
}
/* Produced by CVXGEN, 2015-09-15 18:15:30 -0400.  */
/* CVXGEN is Copyright (C) 2006-2012 Jacob Mattingley, jem@cvxgen.com. */
/* The code in this file is Copyright (C) 2006-2012 Jacob Mattingley. */
...
void Gensolver::ldl_solve(double *target, double *var) {
  ...
  work.v[3] = target[4];
  work.v[4] = target[5];
  work.v[5] = target[6]-work.L[0]*work.v[3];
  work.v[6] = target[0]-work.L[1]*work.v[5];
  work.v[7] = target[7]-work.L[2]*work.v[4]-work.L[3]*work.v[6];
  ...
  work.v[4] -= work.L[2]*work.v[7];
  work.v[3] -= work.L[0]*work.v[5];
...
void Gensolver::ldl_factor(void) {
  ...
  work.L[0] = (work.KKT[4])*work.d_inv[3];
  work.v[4] = work.KKT[5];
  work.d[4] = work.v[4];
  if (work.d[4] < 0)
  ...
  work.L[2] = (work.KKT[6])*work.d_inv[4];
  work.v[3] = work.L[0]*work.d[3];
  work.v[5] = work.KKT[7]-work.L[0]*work.v[3];
  work.d[5] = work.v[5];
  if (work.d[5] > 0)
  ...
  work.L[1] = (work.KKT[8])*work.d_inv[5];
  work.v[5] = work.L[1]*work.d[5];
  work.v[6] = work.KKT[9]-work.L[1]*work.v[5];
  work.d[6] = work.v[6];
  if (work.d[6] < 0)
  ...
  work.L[3] = (work.KKT[10])*work.d_inv[6];
  work.v[4] = work.L[2]*work.d[4];
  work.v[6] = work.L[3]*work.d[6];
  work.v[7] = work.KKT[11]-work.L[2]*work.v[4]-work.L[3]*work.v[6];
  work.d[7] = work.v[7];
  if (work.d[7] > 0)
...
double Gensolver::check_factorization(void) {
  ...
  residual = 0;
  temp = work.KKT[9]-1*work.d[6]*1-work.L[1]*work.d[5]*work.L[1];
  residual += temp*temp;
  ...
  residual += temp*temp;
  temp = work.KKT[5]-1*work.d[4]*1;
  residual += temp*temp;
  temp = work.KKT[4]-work.L[0]*work.d[3]*1;
  residual += temp*temp;
  temp = work.KKT[6]-work.L[2]*work.d[4]*1;
  residual += temp*temp;
  temp = work.KKT[7]-work.L[0]*work.d[3]*work.L[0]-1*work.d[5]*1;
  residual += temp*temp;
  temp = work.KKT[11]-work.L[2]*work.d[4]*work.L[2]-1*work.d[7]*1-work.L[3]*work.d[6]*work.L[3];
  residual += temp*temp;
  temp = work.KKT[8]-1*work.d[5]*work.L[1];
  residual += temp*temp;
  temp = work.KKT[10]-work.L[3]*work.d[6]*1;
  residual += temp*temp;
  return residual;
}
void Gensolver::matrix_multiply(double *result, double *source) {
  /* Finds result = A*source. */
  result[0] = work.KKT[9]*source[0]+work.KKT[8]*source[6]+work.KKT[10]*source[7];
  result[1] = work.KKT[0]*source[1];
  result[2] = work.KKT[1]*source[2];
  result[3] = work.KKT[2]*source[3];
  result[4] = work.KKT[3]*source[4]+work.KKT[4]*source[6];
  result[5] = work.KKT[5]*source[5]+work.KKT[6]*source[7];
  result[6] = work.KKT[4]*source[4]+work.KKT[7]*source[6]+work.KKT[8]*source[0];
  result[7] = work.KKT[6]*source[5]+work.KKT[11]*source[7]+work.KKT[10]*source[0];
}
...
void Gensolver::fill_KKT(void) {
  work.KKT[9] = 2*(params.c2[0]+work.frac_121674190848*work.quad_961296547840[0]);
  ...
  work.KKT[4] = 1;
  work.KKT[6] = 1;
  work.KKT[7] = work.block_33[0];
  work.KKT[11] = work.block_33[0];
  work.KKT[8] = -1;
  work.KKT[10] = 1;
}
