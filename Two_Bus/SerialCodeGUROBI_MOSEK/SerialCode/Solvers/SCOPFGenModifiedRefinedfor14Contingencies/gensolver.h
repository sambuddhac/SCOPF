...
typedef struct Workspace_t {
  ...
  double quad_620699590656[1];
  double quad_557795311616[1];
  double quad_273150955520[1];
  int converged;
} Workspace;
...
//*array<double, 15> getThetaSol(void);
double getObj(void);
