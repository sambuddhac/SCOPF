...
typedef struct Workspace_t {
  ...
  double quad_839165739008[1];
  double quad_112957349888[1];
  double quad_676450217984[1];
  int converged;
} Workspace;
...
//*array<double, 58> getThetaSol(void);
double getObj(void);
