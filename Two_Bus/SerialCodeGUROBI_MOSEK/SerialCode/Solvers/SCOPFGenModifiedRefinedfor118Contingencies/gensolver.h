...
typedef struct Params_t {
  ...
  double rho[1];
  double ones[119];
  double Pg_N_init[119];
  double Pg_N_avg[119];
  double ug_N[119];
  double Vg_N_avg[119];
  double Thetag_N_avg[119];
  double vg_N[119];
  double PgMin[1];
  double PgMax[1];
} Params;
...
typedef struct Workspace_t {
  ...
  double quad_521727352832[1];
  double quad_112396820480[1];
  double quad_877681709056[1];
  int converged;
} Workspace;
...
//*array<double, 119> getThetaSol(void);
double getObj(void);
