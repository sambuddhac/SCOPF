...
typedef struct Workspace_t {
  ...
  double quad_745157136384[1];
  double quad_539813191680[1];
  double quad_931161325568[1];
  int converged;
} Workspace;
...
//*array<double, 31> getThetaSol(void);
double getObj(void);
