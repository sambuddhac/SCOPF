...
/*array<double, 11> Gensolver::getThetaSol(void) {
for ( int i = 0; i <= 10; ++i ) {
...
double Gensolver::eval_objv(void) {
  ...
  objv += params.c0[0]+work.frac_121674190848*(work.quad_324888432640[0]+work.quad_331507691520[0]);
  return objv;
}
...
void Gensolver::multbyP(double *lhs, double *rhs) {
  ...
  lhs[0] = rhs[0]*(2*(params.c2[0]+work.frac_121674190848*work.quad_877793640448[0]));
...
void Gensolver::fill_KKT(void) {
  work.KKT[17] = 2*(params.c2[0]+work.frac_121674190848*work.quad_877793640448[0]);
