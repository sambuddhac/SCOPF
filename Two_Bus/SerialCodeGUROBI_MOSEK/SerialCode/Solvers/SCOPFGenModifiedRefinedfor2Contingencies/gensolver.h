...
typedef struct Workspace_t {
  ...
  double quad_961296547840[1];
  double quad_46264983552[1];
  double quad_955552309248[1];
  int converged;
} Workspace;
...
array<double, 3> getThetaSol(void);
double getObj(void);
